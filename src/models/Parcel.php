...
class Parcel implements Arrayable
{
    ...
    public function fields(): array
    {
        return [
            ...
            'shipment' => fn(Parcel $parcel) => isset($parcel->shippingMethod) ? ['id' => $parcel->getShippingMethod()->getId()] : null,
            'shipping_method_checkout_name' => fn(Parcel $parcel) => $parcel->shippingMethodCheckoutName ?? null,
